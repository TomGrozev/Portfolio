...
export const InlineIcons = {
  ...
  ArangoDB: ArangoDBInline,
  Aws: AwsInline,
  Backend: BackendInline,
  Elixir: ElixirInline,
  Flask: FlaskInline,
  Frontend: FrontendInline,
  Gatsby: GatsbyInline,
  Github: GithubInline,
  Graphql: GraphqlInline,
  Html: HtmlInline,
  Javascript: JavascriptInline,
  Jira: JenkinsInline,
  ...
  Linux: LinuxInline,
  Mail: MailInline,
  Mongodb: MongodbInline,
  Nodejs: NodejsInline,
  Phoenix: PhoenixInline,
  Php: PhpInline,
  Postcss: PostcssInline,
  Python: PythonInline,
  Reactjs: ReactjsInline,
  Redhat: RedhatInline,
  Sass: SassInline,
  Swift: SwiftInline,
  Tag: TagInline,
  Tailwindcss: TailwindcssInline,

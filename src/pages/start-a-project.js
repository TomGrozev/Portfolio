...
const StartAProject = () => (
  <Layout>
    <div className="container relative my-16 px-16">
      <h2 className="text-4xl tracking-tighter text-center leading-normal">I'm writing some random stuff for now about the right length.</h2>
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              ...
              id="contact-name" type="text" placeholder="John" />
          ...
          <div className="w-full md:w-1/2 px-3">
            ...
            <input
              ...
              id="contact-email" type="email" placeholder="Doe" />
          </div>
        </div>
      </form>
    </div>
